local Update1 = loadstring(game:HttpGet('https://sharetext.me/raw/zq3ssvskih'))()
...
_G.TitleTextColor = Color3.fromRGB(230,230,230)
_G.ImageColor = Color3.fromRGB(230,230,230)
_G.LineThemeColor = Color3.fromRGB(230,230,230)
_G.TabTextColor = Color3.fromRGB(230,230,230)
_G.TabImageColor = Color3.fromRGB(230,230,230)
_G.TabThemeColor = Color3.fromRGB(250, 0, 0)
_G.SectionColor = Color3.fromRGB(230,230,230)
_G.SectionImageColor = Color3.fromRGB(230,230,230)
_G.SectionTextColor = Color3.fromRGB(230,230,230)
...
Top.ZIndex = 2
    ...
    PlayTime.Font = Enum.Font.GothamSemibold
    PlayTime.Text = ""
    ...
    Space.Position = UDim2.new(0, 105, 0, 3)
    ...
    Space2.Name = "Space2"
    Space2.Parent = Top
    Space2.BackgroundColor3 = Color3.fromRGB(255,0,0)
    Space2.BackgroundTransparency = 1.000
    Space2.Position = UDim2.new(0, 295, 0, 3)
    Space2.Size = UDim2.new(0, 10, 0, 25)
    Space2.Font = Enum.Font.GothamSemibold
    Space2.Text = "|"
    Space2.TextColor3 = Color3.fromRGB(255,0,0)
    ...
    Pinged.Position = UDim2.new(0, 305, 0, 3)
    Pinged.Size = UDim2.new(0, 225, 0, 25)
    Pinged.Font = Enum.Font.GothamSemibold
    Pinged.Text = ""
    Pinged.TextSize = 15.000
    Pinged.TextColor3 = Color3.fromRGB(255, 255, 255)
...
--[[
		function main:Toggle(text,config,callback)
            ...
            function main:Toggle1(text,config,callback)
                local ToggleImage = Instance.new("Frame")
            ...
            function main:Toggle(TogInfo, default, callback)
                ...
                CheckFrame2.Size = UDim2.new(0, 470, 0, 40)
                ...
                ImageButton.ImageColor3 = Color3.fromRGB(230,230,230)
            ...
            function main:Dropdown(droptitle, list, callback)
                ...
                Frame.Size = UDim2.new(0, 470, 0, 60)
                ...
                DropTextList.TextColor3 = Color3.fromRGB(230,230,230)
                ...
                DropStrokeList.Color = Color3.fromRGB(230,230,230)
                ...
                DropItemStroke.Color = Color3.fromRGB(230,230,230)
                ...
                for i,v in next, list do
                    ...
                    ItemList.TextColor3 = Color3.fromRGB(230,230,230)
...
function main:Textbox(boxtitle, callback)
                ...
                UIStroke2.Color = Color3.fromRGB(230,230,230)
...
function main:PlayerInfo()
			...
			function main:Dropdown1(Name, list, default, callback)
                ...
                Main_Ui2Stroke.Color = Color3.fromRGB(230,230,230)
...
--]]
		...
		function main:Textbox1(text,disappear,callback)
            ...
            Main_U.Color = Color3.fromRGB(230,230,230)
            ...
            Main_U9.Color = Color3.fromRGB(230,230,230)
		...
		function main:Seperator(text)
			...
			Sep3.BackgroundColor3 = Color3.fromRGB(230,230,230)
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=11354741327"
...
local Library = Update:Window("ZEN","",Enum.KeyCode.RightControl);
...
Dungeon = Library:Tab("Dungeon/Esp",11446957539)
...
_G.DistanceMob = 20
Main:Slider("Farm Distance",1,100,20,function(value)
...
--// main farming
local MonsterStatus = Farm:Label("")
local QuestStatus = Farm:Label("")
...
Farm:Toggle("Anti Cheat Bypass", true, function(value)
  _G.SafeFarm = value
CheckAntiCheatBypass()
  Notification("Safe Farm Activated ✅")
end)
...
Farm:Toggle("Auto Farm (No Quest)", AutoFarmNoQuest, function(afnq)
...
Farm:Toggle('Auto Farm All Chest + Hop', _G.GrabChested, function(gacf)
  _G.GrabChested = gacf
end)
...
Farm:Toggle("Auto Trade Bone",_G.Auto_Trade_Bone,function(value)
...
--// Boss Farming
local BossStatus = Farm:Label("")
local BossQuest = Farm:Label("")
...
Farm:Toggle('Auto Farm Boss (No Quest)', toFarmBossNoQuest, function(afbnq)
...
KillPercent = 25
Farm:Slider('Kill Mobs At Health min ... %',1,100,100, function(KillPercentfunc)
...
SkillV = true
SkillF = true
Farm:Toggle('Use Skill Z',SkillZ, function(zfunc)
  SkillZ = zfunc
  end)

Farm:Toggle('Use Skill X', SkillX, function(xfunc)
  SkillX = xfunc
  end)

Farm:Toggle('Use Skill C', SkillC, function(cfunc)
  SkillC = cfunc
  end)

Farm:Toggle('Use Skill V', SkillV, function(vfunc)
  SkillV = vfunc
  end)

Farm:Toggle('Use Skill F', SkillF, function(ffunc)
  SkillF = ffunc
end)
